...
export default class ApiService {
    ...
    static async getLoggedInUserInfo() {
        console.log('ApiService: Fetching logged-in user info');
        const response = await axios.get(`${this.BASE_URL}/user/my-info`, {
            headers: this.getHeader()
        });
        console.log('ApiService: User info response:', response.data);
        return response.data;
    }
    ...
    static async createOrder(body) {
        console.log('ApiService: Creating order with body:', body);
        const response = await axios.post(`${this.BASE_URL}/order/create`, body, {
            headers: this.getHeader()
        });
        console.log('ApiService: Order creation response:', response.data);
        return response.data;
    }
